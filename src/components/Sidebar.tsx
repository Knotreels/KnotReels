    ...
    {!collapsed && "Get Tipped!"}
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-4 px-2 text-gray-400">
              <a href="https://x.com/KnotReels" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">
                <FaXTwitter className="w-5 h-5" />
              </a>
              <a href="https://www.instagram.com/__knotreels__?igsh=MTc3cTZ1M3VjaHNmMA%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">
